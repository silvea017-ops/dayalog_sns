...
<div class="container mt-4">
  <div class="row justify-content-center">
    <div class="col-lg-8 col-md-10">
      ...
      <?php if(!isset($_SESSION['user'])): ?>
        <div class="guest-welcome-section">
          <div id="guestAnimation" class="guest-lottie-animation"></div>
          <h3>Dayalog에 오신 것을 환영합니다!</h3>
          <p>모두와 함께 다양한 이야기를 나눠보세요</p>
...
<?php endif; ?>
  ...
  <?php else: ?>
  <a href="<?php echo BASE_URL; ?>/pages/login.php" class="post-action-btn" onclick="event.stopPropagation();">
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path>
    </svg>
    좋아요
  ...
  <style>
          ...
          .guest-lottie-animation {
            width: 200px;
            height: 200px;
            margin: 0 auto 30px;
          }
          
          .guest-welcome-section h3 {
            font-size: 28px;
            font-weight: 600;
            margin-bottom: 12px;
...
<script>
    // 비로그인 사용자용 Lottie 애니메이션
          if (document.getElementById('guestAnimation')) {
            lottie.loadAnimation({
              container: document.getElementById('guestAnimation'),
              renderer: 'svg',
              loop: true,
              autoplay: true,
